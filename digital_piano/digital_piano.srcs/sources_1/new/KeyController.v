...
module KeyController(
    ...
    // decode the correct note based on input
    always @(*) begin
        case (key_on)
            7'b000_0001: note = 4'd1; 
            7'b000_0010: note = 4'd2;
            7'b000_0100: note = 4'd3;
            7'b000_1000: note = 4'd4;
            7'b001_0000: note = 4'd5;
            7'b010_0000: note = 4'd6;
            7'b100_0000: note = 4'd7;
            default: note = 4'd0;
        endcase
    end
